...
Streamlined, blazing fast frontend-only skeleton for building Astro 6.0 marketing websites. This template provides a clean slate with Tailwind CSS and Netlify deployment pre-configured.
